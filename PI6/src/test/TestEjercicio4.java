...
import ejercicios.ejercicio4.Arista;
import ejercicios.ejercicio4.Vertice;
import ejercicios.ejercicio4.Heuristica;
...
public class TestEjercicio4 {
	...
	public static void main(String[] args) {
		for (int i = 1; i < 3; i++) {
			String inputPath = System.getProperty("user.dir") + "\\tests\\PI6Ej4DatosEntrada" + i + ".txt";
			System.out.println("Para el fichero PI6Ej4DatosEntrada" + i + ".txt");
