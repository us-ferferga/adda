...
import ejercicios.ejercicio2.Heuristica;
...
public class TestEjercicio2 {
	...
	public static void main(String[] args) {
		for (int i = 1; i < 3; i++) {
			String inputPath = System.getProperty("user.dir") + "\\tests\\PI6Ej2DatosEntrada" + i + ".txt";
			System.out.println("Para el fichero PI6Ej2DatosEntrada" + i + ".txt");
