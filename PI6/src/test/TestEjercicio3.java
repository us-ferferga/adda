...
import ejercicios.ejercicio3.Arista;
import ejercicios.ejercicio3.Vertice;
import ejercicios.ejercicio3.Heuristica;
...
public class TestEjercicio3 {
	...
	public static void main(String[] args) {
		for (int i = 1; i < 3; i++) {
			String inputPath = System.getProperty("user.dir") + "\\tests\\PI6Ej3DatosEntrada" + i + ".txt";
			System.out.println("Para el fichero PI6Ej3DatosEntrada" + i + ".txt");
