...
public class BackTracking {
	...
	public static class State {
		...
		void forward(Integer a) {
			...
			this.valorAcumulado = this.valorAcumulado() + a * Modelo.valorCandidato(vertice.index());
			this.vertice = vecino;
		}
	...
	public static void search(Integer presupRestante) {
		BackTracking.start = new Vertice(0, new ArrayList<>(), presupRestante);
	...
	public static void search() {
		...
		if (BackTracking.estado.vertice().index() == Modelo.lenCandidatos()) {
			...
			List<Integer> alternativas = BackTracking.estado.vertice().actions();
