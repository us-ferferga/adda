...
public class TestEjercicio1 {
	...
	public static void main(String[] args) throws IOException {
		...
		List<String> lineasFichero = Helper.leerLineas(
				System.getProperty("user.dir") + "\\src\\ficheros\\PI1E1_DatosEntrada.txt"
		);
		
		Predicate<String> contieneVocales = s -> s.contains("a") || 
				s.contains("e") || 
				s.contains("o") ||
				s.contains("A") ||
				s.contains("E") ||
