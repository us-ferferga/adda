...
import ejercicios.ejercicio4.AlgoritmoGenetico;
import ejercicios.ejercicio4.Modelo;
...
public class TestEjercicio4 {
	...
	public static void main(String[] args) {
		String model = System.getProperty("user.dir") + "\\modelos_pl\\contenedores.lsi";
		...
		for (int i = 1; i < 4; i++) {
			String inputPath = System.getProperty("user.dir") + "\\tests\\PI5Ej4DatosEntrada" + i + ".txt";
			String modelOutput = System.getProperty("user.dir") + "\\modelos_gurobi\\contenedores-" + i + ".lp";
		...
		for (int i = 1; i < 4; i++) {
			...
			System.out.println("======== PLE (PI5Ej4DatosEntrada" + i + ".txt) ========");
			System.out.println();
			System.out.println(pl);
			System.out.println();
			System.out.println("======== PLE (PI5Ej4DatosEntrada" + i + ".txt) ========");
			System.out.println("========  AG (PI5Ej4DatosEntrada" + i + ".txt) ========");
			System.out.println();
