...
import ejercicios.ejercicio3.AlgoritmoGenetico;
...
public class TestEjercicio3 {
	...
	public static void main(String[] args) {
		String model = System.getProperty("user.dir") + "\\modelos_pl\\productos.lsi";
		...
		for (int i = 1; i < 4; i++) {
			String inputPath = System.getProperty("user.dir") + "\\tests\\PI5Ej3DatosEntrada" + i + ".txt";
			String modelOutput = System.getProperty("user.dir") + "\\modelos_gurobi\\productos-" + i + ".lp";
		...
		for (int i = 1; i < 4; i++) {
			...
			System.out.println("======== PLE (PI5Ej3DatosEntrada" + i + ".txt) ========");
			System.out.println();
			System.out.println(pl);
			System.out.println();
			System.out.println("======== PLE (PI5Ej3DatosEntrada" + i + ".txt) ========");
			System.out.println("========  AG (PI5Ej3DatosEntrada" + i + ".txt) ========");
			System.out.println();
